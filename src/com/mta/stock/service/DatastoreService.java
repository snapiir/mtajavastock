...
public class DatastoreService {
	...
	private void updateStocks(ArrayList<Stock> newArrayList) {
	...
	private StockStatus fromStockEntry(Entity stockEntity) {
		...
		ret.setEdate((Date) stockEntity.getProperty(DAY));
	...
	private Entity stockToEntity(StockStatus stock) {
		Key parent = KeyFactory.createKey("date", stock.getEdate().getTime());
		...
		entity.setProperty(DAY, stock.getEdate());
